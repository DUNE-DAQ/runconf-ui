...
```
Please note that these are just helpers. In a deployment context, daq experts can completely disregard them and/or develop new ones for other detectors not listed in this repo.
