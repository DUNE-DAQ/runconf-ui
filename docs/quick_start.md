...
To get started, follow the [Installation Guide](installation.md) to set up the environment and install the necessary dependencies. Once runconf-ui is installed you can launch the application and start exploring its features.
