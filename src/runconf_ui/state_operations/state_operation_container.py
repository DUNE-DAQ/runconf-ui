...
class StateOperationContainer(DisableOperation):
    ...
    def __init__(self, configuration: Configuration, 
                 session: DalBase, 
                 contained_resources: Optional[Sequence[StateOperation]]=None):
        
        super().__init__(configuration, session)
        
        self.contained_operations: Sequence[StateOperation] = contained_resources if contained_resources else []
