...
from runconf_ui.state_operations.state_operation import StateOperation, DisableOperation
from runconf_ui.exceptions import IncorrectAttributeException, AttributeValueException
...
class DalAttribute:
    ...
    '''
    def _init_attribute(self, configuration: Configuration, dal: DalBase, attribute_name: str):
        self.dal = dal
...
class DisableAttribute(DisableOperation, DalAttribute):
    ...
    def __init__(
        ...
        self._init_attribute(configuration, dal, attribute_name)
    ...
    def get_state(self) -> bool:
        ...
        return value == self.enabled_value
