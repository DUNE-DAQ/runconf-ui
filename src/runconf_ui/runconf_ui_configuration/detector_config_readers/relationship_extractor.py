...
class RelationshipExtractor(AttributeExtractor):
    ...
    def __init__(
        ...
        logging.info(f"Initializing RelationshipExtractor for class: {self._relationship_class}")
        ...
        logging.info(f"State is in {ca.GetDalObjectAction(self._application_controller.buffer_daq_config)(getattr(self._enabled_state[0], 'id'), self._relationship_class)}")
    ...
    def _get_states(
        ...
        configuration: DaqConfigurationWrapper
    ...
    def _find_enable_disable_state(
        ...
        try:
            ...
            full_config = DaqConfigurationWrapper(self._application_controller.current_daq_config)
            ...
            for state_obj in states_list:
                ...
                ca.UpdateDalAction(self._application_controller.buffer_daq_config)(copied_obj)
                ca.CommitConfigurationAction(self._application_controller.buffer_daq_config)()
